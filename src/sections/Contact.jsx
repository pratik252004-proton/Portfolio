  ...
  return(
    ...
    md:flex-row items-center gap-10">
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row items-center gap-10">
        ...
        >
          <motion.img src={SpaceMan} alt="Astronaut"
        ...
        >
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              ...
              >
            <option vlaue="Something in mind?" disabled>
            Something in mind?
            </option>
            <option vlaue="Data-Preprocessing" className="text-black">
            Data-Preprocessing  
            </option>
            <option vlaue="Model-Training" className="text-black">
            Model-Training  
            </option>
            <option vlaue="Open CV" className="text-black">
            Open CV
            </option>
            <option vlaue="Others" className="text-black">
            Others 
            </option>

              </select>
              {errors.service && <p className="text-red-500 text-xs">{errors.email}</p>}
